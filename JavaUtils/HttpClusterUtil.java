...
public class HttpClusterUtil {
     ...
     * 
     */
    private static HttpClusterUtil instance;
     ...
     * @return HTTP实例
     */
    public static HttpClusterUtil instance() {
        if (instance == null) {
            instance = new HttpClusterUtil();
        }
        return instance;
    }
...
//        httppost.completed();
    ...
    public static void main(String[] args) throws Exception {
        ...
        String result = HttpClusterUtil.instance().post("https://192.168.1.83:8443/", params);
