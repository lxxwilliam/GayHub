...
public class HttpClientUtils {
	...
	public static void main(String[] args) {
		try {
			...
			String str= get("https://ssl-meta.che300.com/meta/series/series_brand115.json");
			/*
			 ...
			 * 10000);
			 */
//			Document doc = Jsoup.parse(new URL("https://www.che300.com/"), 10000);
//			Element ele = doc.select("div.brand").first();
//			Elements brands = ele.select("p[rel]");
//			for (int i = 0; i < brands.size(); i++) {
//				Element brand = brands.get(i);
//				String name = brand.text();
//				String id = brand.id();
//				String initial = brand.attr("rel");
//				System.out.println("name="+name +",id="+id+",initial="+initial);
//			}
			str = String.format("dd%1$sdd", "ttttttttttt");
